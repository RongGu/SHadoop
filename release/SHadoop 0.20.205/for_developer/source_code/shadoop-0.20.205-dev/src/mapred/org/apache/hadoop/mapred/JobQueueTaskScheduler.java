...
class JobQueueTaskScheduler extends TaskScheduler {
  ...
  public synchronized List<Task> assignTasks(TaskTracker taskTracker)
    ...
    LOG.info("try assign task for tracker: "+taskTracker.getTrackerName());
    ...
    synchronized (jobQueue) {
      for (JobInProgress job : jobQueue) {
        //TODO modified by yang xiaoliang
        LOG.info("param JobStatus.RUNNING="+JobStatus.RUNNING);
        LOG.info("job.getStatus().getRunState()="+job.getStatus().getRunState());
...
//    LOG.info("mapLoadFactor="+mapLoadFactor);
    final int trackerCurrentMapCapacity = 
      Math.min((int)Math.ceil(mapLoadFactor * trackerMapCapacity), 
                              trackerMapCapacity);
    int availableMapSlots = trackerCurrentMapCapacity - trackerRunningMaps;
//    //TODO modified by yang xiaoliang
//    LOG.info("trackerCurrentMapCapacity="+trackerCurrentMapCapacity);
//    LOG.info("trackerRunningMaps="+trackerRunningMaps);
//    LOG.info("availableMapSlots="+availableMapSlots);
...
//          //TODO modified by yang xiaoliang 
//          LOG.info("obtainNewNodeOrRackLocalMapTask: "+t == null? "null" :
//        	  t.getTaskID());
          if (t != null) {
            assignedTasks.add(t);
            ++numLocalMaps;
